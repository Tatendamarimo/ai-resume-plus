      ...
      <div className="p-6 h-full flex flex-col justify-between">
        ...
        <div className="flex gap-2 mt-4">
          <Button
            ...
            onClick={() => navigate(`/dashboard/resume/${resume._id}/score`)}
          >
            Check Score
          </Button>
          <Button
            variant="outline"
            size="sm"
            className="flex-1 text-xs border-secondary/30 text-secondary hover:bg-secondary/10"
            onClick={() => navigate(`/dashboard/resume/${resume._id}/interview`)}
          >
            Interview Prep
          </Button>
        </div>
