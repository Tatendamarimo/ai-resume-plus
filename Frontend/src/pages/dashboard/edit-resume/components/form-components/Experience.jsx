  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-8">
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-100">Work Experience</h2>
          <p className="text-gray-400 mt-1 text-sm md:text-base">Your professional journey</p>
        </div>
      </div>
