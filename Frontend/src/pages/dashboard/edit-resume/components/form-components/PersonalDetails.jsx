          ...
          <div className="space-y-6">
            <div className="relative group">
              ...
              <Input
                ...
                className="bg-gray-800 border-2 border-gray-700 focus:border-primary focus:ring-0 h-12 text-gray-100 rounded-xl transition-all group-hover:border-primary/50"
                required
              />
            </div>
