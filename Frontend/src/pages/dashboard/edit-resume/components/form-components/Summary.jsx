...
function Summary({ resumeInfo, enanbledNext, enanbledPrev }) {
  ...
  return (
    <motion.div
      ...
      className="p-4 md:p-6 rounded-xl lg:rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 shadow-lg md:shadow-2xl"
    >
      {/* Header Section */}
      ...
      <form onSubmit={handleSave} className="space-y-6 md:space-y-8">
        <div className="space-y-4 md:space-y-6">
          ...
          <Textarea
            ...
            className="min-h-[120px] md:min-h-[150px] text-sm md:text-base bg-gray-800 border-2 border-gray-700 focus:border-primary focus:ring-0 text-gray-100 rounded-lg md:rounded-xl transition-all hover:border-primary/50"
